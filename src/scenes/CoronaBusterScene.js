...
export default class CoronaBusterScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("left-button", "images/left-btn.png");
    this.load.image("right-button", "images/right-btn.png");
    this.load.image("shoot-button", "images/shoot-btn.png");
  }
  create() {
  ...
  createButton(){
    ...
    let shoot = this.add.image(320,550, 'shoot-button').setInteractive().setDepth(0.5).setAlpha(0.8)
    
    let nav_left = this.add.image(50,550, 'left-button').setInteractive().setDepth(0.5).setAlpha(0.8)
    
    let nav_right = this.add.image(nav_left.x + nav_left.displayWidth+20, 550,'right-button').setInteractive().setDepth(0.5).setAlpha(0.8)
